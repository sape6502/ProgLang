<div class="box">
    ...
    <?php
        ...
        if (isset($_SESSION['username'], $_SESSION['trustScore']) && $_SESSION['trustScore'] >= $min_make_comments)
            echo '<a href="/page/comment/index.php/?pid=' . $post_idnum . '&cid=' . $comment_idnm . '">Reply to this comment.</a>';
    ?>
